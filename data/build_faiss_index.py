...
# Đường dẫn input & output (sử dụng __file__ để luôn đúng thư mục)
...
# Load dữ liệu metadata từ file JSON
with open(DATA_PATH, "r", encoding="utf-8") as f:
    products = json.load(f)

# Lọc sản phẩm có mô tả (description) đầy đủ
products = [p for p in products if p.get("description")]

# Khởi tạo mô hình embedding
model = SentenceTransformer("sentence-transformers/all-MiniLM-L6-v2")

# Tạo embedding từ mô tả
...
# Lưu metadata tương ứng theo thứ tự
metadata = []
